...
PR: https://github.com/RaaSaaR-org/open-embodied-jepa/pull/6. Initial remote core checks passed; integration correctly failed because the new optional backend was not installed/fetched in CI. Updated the optional integration job to install its locked extra and fetch the audited source explicitly, keeping the no-unexpected-skips guard. This supplies actual upstream coverage rather than permitting new skips. Merge pending corrected CI.

Remote delivery verified: PR #6 merged as `e96c38908e7a20820b6d390b13f872e2d128ae06`; Linux/macOS core and optional macOS integration checks passed for both the reviewed PR head and merged main commit. Local main was fast-forwarded.
