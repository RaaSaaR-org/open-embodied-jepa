...
This research task can close on the protocol-defined negative outcome; it does not close TASK-033 or TASK-034. Evidence: `docs/experiments/apple_aligned_control_results_v1.md`, `benchmarks/manifests/apple-aligned-cost-v1.json`, and the two aligned-sensor reviews. Independent saved-evidence review and PR delivery are pending.
